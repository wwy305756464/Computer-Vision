...
def point_line_distance(line, point):
    ...
    error = (line[0]*point[0] + line[1]*point[1] + line[2]) / math.sqrt(line[0] ** 2 + line[1] ** 2)
...
def signed_point_line_errors(x_0s, F, x_1s):
    ...
    for i in range (len(x_0s) ):
        ...
        line1 = F.dot(x1_i)
        point1 = x0_i
        line2 = np.transpose(F).dot(x0_i)
        point2 = x1_i
        error1 = point_line_distance(line1, point1)
        error2 = point_line_distance(line2, point2)
